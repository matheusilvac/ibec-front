      ...
      <div className="w-full h-full flex flex-col justify-center items-center mb-5 sm:mb-20 px-5 md:px-10">
        ...
        <div className="w-full flex justify-center items-center h-full">
          <img
            src="/arvores.png"
            alt=""
            className="w-full sm:w-2/4 h-auto flex"
          />
        </div>
      </div>
      <div className="w-full h-full flex flex-col sm:flex-row justify-center sm:justify-around items-center mb-10 px-5 md:px-20">
        <div className="w-full sm:w-1/2 flex flex-col justify-center items-center gap-3 mb-5">
          ...
          <p className="flex justify-center items-center text-center sm:text-left text-lg">
            ...
            disso, sejam capacitados a servir à Igreja de Cristo com eficácia e
            integridade. A teologia ensinada no IBEC visa à construção de um
