  ...
  return (
    <div className="w-full h-full flex flex-col pt-32 pb-10 text-[#0A1A2D]">
      <div className="w-full h-full flex flex-col justify-center items-center mb-20 px-5 md:px-20">
        <div className="w-full h-full flex flex-col sm:flex-row justify-center md:justify-around items-center mb-10 px-5 md:px-20">
          <div className="w-full h-full sm:w-1/2 justify-center items-center flex text-start mb-5 sm:mb-0">
            <h1 className="text-7xl text-left uppercase font-semibold">
          ...
          <div className="w-full h-full sm:w-1/2 flex justify-center items-center">
            <p className="text-center sm:text-left text-xl">
              <strong className="text-3xl text-[#e6a44e]">
                Mateus 7:17-20
              </strong>
              , que enfatiza que uma{" "}
              <strong className="text-[#e6a44e]">“árvore boa”</strong> é
              ...
              <br />
              <br />O conceito de{" "}
              <strong className="text-[#e6a44e]">“bons frutos”</strong> reforça
        ...
        <div className="w-full flex justify-center items-center h-full">
          <img src="/arvores.png" alt="" className="w-1/2 h-auto flex" />
        </div>
      </div>
