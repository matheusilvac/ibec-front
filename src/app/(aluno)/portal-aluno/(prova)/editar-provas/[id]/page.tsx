        ...
        <Group grow className="gap-2">
          <div className="gap-4 flex flex-col">
            <Field.Root required>
              ...
              <Input
                ...
                className="bg-gray-100 rounded-lg pl-2 border-gray-300"
              />
            </Field.Root>
            <Select.Root
              multiple
              collection={modulosProva}
              size="md"
              value={valueModulos}
          ...
          <div className="gap-4 flex flex-col">
            <Field.Root required>
              ...
              <Input
                disabled
                placeholder="Bibliologia..."
                value={valueApostila}
                onChange={(e) => setValueApostila(e.target.value)}
                className="bg-gray-100 pl-2 border-gray-300"
              />
            </Field.Root>
            <Field.Root required>
              <Field.Label>
