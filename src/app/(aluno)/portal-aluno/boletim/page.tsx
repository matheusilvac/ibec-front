...
export default function BoletimPage(){
    ...
    useEffect(() => {
        ...
        axios.get("https://portal-aluno-ibec-cgdhfngvhfb2g3f6.canadacentral-01.azurewebsites.net/api/auth/user",
            {
                headers: {
        ...
        if (user != null) {
            axios.get<NotaProps[]>(`https://portal-aluno-ibec-cgdhfngvhfb2g3f6.canadacentral-01.azurewebsites.net/api/medias/${user?.id}/situacao`, {
    ...
    return(
        <div className="w-full flex flex-col  gap-10">
            <div className="w-full flex">
                <h1 className="flex text-2xl font-bold">Veja aqui suas notas e faltas em todas as matérias.</h1>
            </div>
